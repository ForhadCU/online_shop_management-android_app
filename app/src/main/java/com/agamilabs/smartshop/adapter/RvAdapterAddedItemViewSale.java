...
public class RvAdapterAddedItemViewSale extends RecyclerView.Adapter<RvAdapterAddedItemViewSale.MyViewHolder> {
    private List<InvoiceItemModel> invoiceItemModelList;
    private Context context;
    private ICallBackFromFullScannerActivitySale icallBackTest;
    private boolean mAutoIncrement = false;
    private boolean mAutoDecrement = false;
    private Handler repeatUpdateHandler = new Handler();


    public RvAdapterAddedItemViewSale(List<InvoiceItemModel> invoiceItemModelList, Context context, ICallBackFromFullScannerActivitySale icallBackTest) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_selected_product_view_layout_sale, parent, false);
