...
public class RvAdapterSelectedProductDetailsView extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//    private int isItemListVisible = 0;
    ...
    public RvAdapterSelectedProductDetailsView(ArrayList<InvoiceModel> invoiceModelList, Context context) {
